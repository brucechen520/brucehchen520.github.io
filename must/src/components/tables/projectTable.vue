  ...
  <div>
    ...
    <div class="ls-md">
      <template v-for="item in items">
        <b-card :key="item.id">
          <h4 class="d-inline-block">{{item.project_Name}}</h4>
    ...
    <b-modal id="bv-modal-example" hide-footer>
      <template v-slot:modal-title>專案詳情</template>
      <b-card>
        <b-row class="mb-1">
          <b-col cols="5">
            <b>序號:</b>
        ...
        <b-row class="mb-1">
          ...
          <b-col>{{ focusItem.project_Name }}</b-col>
        </b-row>
        <b-row class="mb-1">
          <b-col cols="5">
            <b>公司名稱:</b>
        ...
        <b-row class="mb-1">
          ...
          <b-col>{{datetimeFormat(parseInt(focusItem.deadline))}}</b-col>
        </b-row>
        <b-row class="mb-1">
          <b-col cols="5" class>
            <b>公司網址:</b>
